...
try:
    ...
    # Función auxiliar para renderizar filas uniformes y evitar fuentes desproporcionadas
    def fila_resultado(etiqueta, valor):
        st.markdown(
            f"""
            <div style="background-color: #f8fafc; padding: 8px 12px; border-radius: 4px; border: 1px solid #cbd5e1; margin-bottom: 6px; display: flex; justify-content: space-between; align-items: center;">
                <span style="color: #0369a1; font-weight: bold; font-size: 13px;">{etiqueta}</span>
                <span style="color: #1e293b; font-weight: bold; font-size: 13px;">{valor}</span>
            </div>
        """,
            unsafe_allow_html=True,
        )
    ...
    st.markdown(
        f"""
        <div style="background-color: #e0f2fe; padding: 12px; border-radius: 6px; border: 1px solid #0284c7; display: flex; justify-content: space-between; align-items: center;">
            <span style="color: #0284c7; font-weight: bold; font-size: 14px;">TSG por Servicios Generales Total:</span>
            <span style="color: #0284c7; font-weight: bold; font-size: 16px;">{fmt(tasa_total)}</span>
        </div>
    """,
        unsafe_allow_html=True,
    )
